...
import com.example.osamashanti.androidorderfoods.Cart;
...
public class CartAdapter extends RecyclerView.Adapter<CartViewHolder>{
    ...
    public void onBindViewHolder(@NonNull CartViewHolder holder, final int position) {
        ...
        holder.img_cart_count.setImageDrawable(drawable); //img red
*/
        //Picasso.get()
        Picasso.with(cart)
        ...
        holder.txt_price.setText(fmt.format(price)); // the price

        holder.txt_cart_name.setText(listData.get(position).getProductName());//the Name
